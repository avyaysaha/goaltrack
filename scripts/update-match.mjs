...
const publishedJsPath = path.join(root, "manual-data.js");
...
const browserData = `// Generated by the private "Update Match Manually" GitHub Action.\nwindow.GOALTRACK_MANUAL_DATA = ${JSON.stringify(data, null, 2)};\n`;
fs.writeFileSync(jsPath, browserData);
// GitHub Pages currently publishes this repository's root directory.
fs.writeFileSync(publishedJsPath, browserData);
